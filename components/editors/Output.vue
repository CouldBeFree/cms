...
<script>
  ...
  class OutputEditor extends Vue {
    ...
    async run (code) {
      let js = (code.js && (code.js.compiled || code.js.source)) || '';
      let html = (code.html && (code.html.compiled || code.html.source)) || '';
      let css = (code.css && (code.css.compiled || code.css.source)) || '';
      const scripts = [];
